...
from common.utils.model import clone_model, get_soft_target_model_ops
from common.utils.numerics import gradient_inverter, huber_loss
from common.memory import Experience
from common.rlagent import RLAgent
from common.utils.printer import print_warning
...
class DDPGAgent(RLAgent):
    ...
    def __init__(self,
                 ...
                 warmup_actor_steps=10000,
                 warmup_critic_steps=10000,
    ...
    def forward(self, observation):
        ...
        #action = np.clip(np.random.normal(action, self.var), self.actions_low, self.actions_high)    # add randomness to action selection for exploration
        #self.var *= .9995
