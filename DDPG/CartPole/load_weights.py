...
json_file = open('save/Actor.json', 'r')
loaded_model1 = json_file.read()
json_file.close()
model_actor = model_from_json(loaded_model1)

json_file = open('save/Critic.json', 'r')
loaded_model2 = json_file.read()
json_file.close()
model_critic = model_from_json(loaded_model2)
