...
with open('save/history3_2018-06-20 10:24:39', 'r') as f:
    pp1_1 = json.load(f)
    f.close()

with open('save/history3_2018-06-20 12:57:42', 'r') as f:
    pp1_2 = json.load(f)
    f.close()

with open('save/history3_2018-06-20 10:26:37', 'r') as f:
    pp1_3 = json.load(f)
    f.close()

with open('save/history3_2018-06-20 11:10:24', 'r') as f:
    pp1_4 = json.load(f)
    f.close()
...
pyplot.title('Batch size comparison', fontsize=24)

new_ticks = np.linspace(0, 3000, 30)
pyplot.xticks(new_ticks)
pyplot.plot(er_ave1, 'r', label='batch_size=32')
pyplot.plot(er_ave2, 'g', label='batch_size=64')
pyplot.plot(er_ave3, 'y', label='batch_size=96')

pyplot.legend()
pyplot.savefig('save/pics/cartpole_batch_size.png',bbox_inches='tight')
...
pyplot.savefig('save/pics/cartpole_duration_BS.png',bbox_inches='tight')
pyplot.show()
