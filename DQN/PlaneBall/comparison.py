...
with open('save/history3_2018-06-22 12:10:38', 'r') as f:
    pp1_1 = json.load(f)
    f.close()
...
with open('save/history5_2018-06-22 12:10:44', 'r') as f:
    pp1_3 = json.load(f)
    f.close()
...
pyplot.title('Discounted rate comparison')
...
pyplot.legend()
pyplot.savefig('save/pics/discount_rate.png',bbox_inches='tight')
'''
#pyplot.subplot(2, 1, 1)
pyplot.xlabel('total steps')
pyplot.ylabel('rewards per episode')
pyplot.plot(pp1_1['nb_steps'], pp1_1['episode_reward'], 'r', label='320,0.01')
pyplot.plot(pp1_2['nb_steps'], pp1_2['episode_reward'], 'g', label='320,0.1')
pyplot.plot(pp1_3['nb_steps'], pp1_3['episode_reward'], 'b', label='320,50000')
...
#pyplot.plot(pp1_2['nb_steps'], pp1_2['nb_episode_steps'], 'g', label='EpsDisGreedy with random action in 1000 warm_up steps, 1-0.01')
pyplot.legend()
...
pyplot.savefig('save/pics/duration_DR.png',bbox_inches='tight')
'''
pyplot.show()
