...
class TrainEpisodeLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        template = 'step: {step}: episode: {episode}, duration: {duration:.3f}s, episode steps: {episode_steps}, episode reward: {episode_reward:.3f}, mean reward: {reward_mean:.3f} [{reward_min:.3f}, {reward_max:.3f}], final_observation: {obs_last}, {metrics}'
        variables = {
            'step': self.step,
