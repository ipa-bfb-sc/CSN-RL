...
### learning rate comparison: 0.001, 0.01, target_net comparison: 0.001, 0.01

# history 1: lr=0.01, memory=50000, target_update=0.01
with open('save/nhistory1_2018-07-17 19:21:49', 'r') as f:
    pp1_1 = json.load(f)
    f.close()
with open('save/nhistory1_2018-07-18 23:15:58', 'r') as f:
    pp1_2 = json.load(f)
    f.close()
with open('save/nhistory1_2018-07-18 23:16:09', 'r') as f:
    pp1_3 = json.load(f)
    f.close()
...
# history 2: lr=0.001, memory=50000, target_update=0.01
with open('save/nhistory2_2018-07-18 23:21:56', 'r') as f:
    pp2_1 = json.load(f)
    f.close()

with open('save/nhistory2_2018-07-18 23:22:34', 'r') as f:
    pp2_2 = json.load(f)
    f.close()

with open('save/nhistory2_2018-07-18 23:23:09', 'r') as f:
    pp2_3 = json.load(f)
    f.close()


# history 3: lr=0.001, memory=50000, target_update=0.001
with open('save/nhistory3_2018-07-19 15:39:23', 'r') as f:
    pp3_1 = json.load(f)
    f.close()

with open('save/nhistory3_2018-07-19 15:39:34', 'r') as f:
    pp3_2 = json.load(f)
    f.close()

with open('save/nhistory3_2018-07-19 15:39:50', 'r') as f:
    pp3_3 = json.load(f)
    f.close()
...
x = np.linspace(1000, 199700, num=200000)
...
pyplot.title('"learning rate" and "target_net update interval" comparison-reward', fontsize=24)

pyplot.plot(f_avg1, 'red', label='lr=0.01, target_update=0.01')
pyplot.plot(f_avg2, 'b', label='lr=0.001, target_update=0.01', alpha=0.5)
#pyplot.plot(f_avg3, 'g', label='lr=0.01, target_update=0.001', alpha=0.5)
pyplot.legend()
pyplot.savefig('save/pics/dqn_cirturtlebot_reward1.png',bbox_inches='tight')
...
pyplot.plot(f_avg3, 'g', label='lr=0.01, target_update=0.001', alpha=0.5)
pyplot.legend()
pyplot.savefig('save/pics/dqn_cirturtlebot_reward2.png',bbox_inches='tight')
...
pyplot.xticks(x, ('lr=0.01,\ntarget_update=0.01', 'lr=0.001,\ntarget_update=0.01', 'lr=0.01,\ntarget_update=0.001'))
ax.set_ylabel('Duration')
ax.set_title('Training time')
pyplot.savefig('save/pics/dqn_cirturtlebot_duration.png',bbox_inches='tight')
