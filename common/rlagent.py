...
from common.callbacks import TestLogger, TrainEpisodeLogger, TrainIntervalLogger, Visualizer, CallbackList
from common.utils.printer import print_status
from common.runtime.agent import Agent
from common.utils.numerics import normalize
...
#        if callbacks is None:
        ...
        if termination_criterion == STEPS_TERMINATION:
            ...
            def termination():
                return ((self.episode - start_episode >= episodes) or self.abort)
